...
class _Matrix_Helper:
    ...
    @staticmethod
    def __find_matrix__REDUCED_SVM__(P, n, C):
    ...
    @staticmethod
    def __find_matrix__REDUCED_QASVM__(P, n, C):
    ...
    # noinspection DuplicatedCode
    @staticmethod
    def __find_matrix__REDUCED_PRIMAL_SVM__(P, n, C):
        q1 = np.zeros(n)
        if C is None:
            q2 = np.zeros(n)
        else:
    ...
    # noinspection DuplicatedCode
    @staticmethod
    def __find_matrix__REDUCED_PRIMAL_QASVM__(P, n, C):
